...
\begin{equation}\label{eqn:loglik1}
  \begin{array}{ll}
    \log L(\Lambda | H) & = \sum_{i,j,k} \left(\sum_{m=1}^w\log\lambda_{ijk}\times I{\{\context{m} = ijk\}} - c_{ijk}(v_{m-1})\lambda_{ijk}\Delta_m\right)\\[.5em]
...
\subsection{Latent data inference for an individual site}
